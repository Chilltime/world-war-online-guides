...
- Open recruitment for players to request membership
- Close recruitment for invite-only
...
- Promote up to **3 Captains** to help manage

### Choosing Captains

Promote trusted members to Captain to help with:
...
- **Plan together** - Involve members in strategic decisions
